...
${indent(code)}
  ...
  zip.file('index.js', fs.readFileSync(__dirname + '/../dist/code.build.js'))

  /*console.log({
    fileSize: fs.readFileSync(__dirname + '/../dist/code.build.js').toString().length
  })*/

  fs.unlinkSync(__dirname + '/../code.js')
  fs.unlinkSync(__dirname + '/../dist/code.build.js')
